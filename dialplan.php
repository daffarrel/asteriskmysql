...
.mydroppable {
 ...
 .mydraggable 
	{
    width: 150px; 
	height: 11px; padding: 0.5em; float: left; margin: 10px 10px 10px 0; top:10px; left:10px; background-color: #FC6; z-index:10; }
	...
	<div class="row-fluid sortable">	
		<div class="box span12">
			...
			<div class="box-content">
				...
				<p class="mydraggable" title="Use Me To Answer">Answer()</p>
				<table>
					<tr>
						<td><div class="mydroppable " id="dpbox">Drop Here to generate Dialplan</div></td>
						<td><div class="mydroppable " id="gendp">Generated</div></td>
					</tr>
				</table
			</div>
		</div>
	...
	<div class="row-fluid sortable">	
		<div class="box span12">
			...
			<div class="box-content">
			 ...
			 <p>
                        	<div class="reload">
                                	<div id="dialog-message" title="Done!">
                                        	<p>
                              	...
                              	<?php
                                        ...
                                        echo "<button id='reloaddp' class='btn btn-primary'><i class='icon-zoom-in icon-refresh'></i>Reload</button>";
                                        echo "<br><form action='".$_SERVER['PHP_SELF']."#dialplan' method='post' >";
                                        echo "<style type=text/css>
                                                textarea#styled {
                                                width: 720px;
                                                height: 550px;
                                        ...
                                        echo "<textarea   id='styled' name='newd' > $data </textarea>
                                        <br><button class='btn btn-primary'><i class='icon icon-darkgray icon-save'></i>Save</button>
                                        </form>";
                                ?>
                        </p>
