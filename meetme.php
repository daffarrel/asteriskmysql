...
<div class="sortable row-fluid">
				...
				<a data-rel="tooltip" title="Created  Conferences" class="well span3 top-block" href="#">
					<span class="icon32 icon-blue icon-messages"></span>
					<div>Total of Rooms</div>
					<?php
						$res=mysql_query("select * from meetme") or die(mysql_error());
						$conf=mysql_num_rows($res);
						echo "<div>$conf</div>";
					?>
		...
		<div class="box span12">
			...
			<div class="box-content">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a href="#createdmeet">Created Rooms</a></li>
					<li><a href="#addnewmeet">Add New</a></li>
				</ul>
					 

				<div id="myTabContent" class="tab-content">
					<div class="tab-pane active" id="createdmeet">

	                        	        <div id="dialog-deletemeet" Title="Alert">
        	                        	        <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Delete this Room?</p>
	        	                        </div>

						<!-- form to edit peers -->
	                        	        <div id="dialog-form2meet" title="Edit Meetme Room">
        	                        	        <br>
                	                        	<form>
	                        	                      	<table align=center class='ui-widget ui-widget-content'>
        	                        		                <tr><td><label for="confno">Room Number</label></td><td><input type="text" name="confno" id="confnoed" class="input-large ui-widget-content ui-corner-all" READONLY /></td></tr>
                	                        		        <tr><td><label for="pin">PIN</label></td><td><input type="text" name="pin" id="pined" value="" class="input-large ui-widget-content ui-corner-all" /></td></tr>
                        	                        		<tr><td><label for="adminpin">Admin PIN</label></td><td><input type="text" name="adminpin" id="adminpined" value="" class="input-large ui-widget-content ui-corner-all" /></td></tr>
		                        	                        <tr><td><label for="maxusers">Maximun Users</label></td><td><input type="text" name="maxusers" id="maxusersed" value="" class="input-large ui-widget-content ui-corner-all" /></td></tr>
        	                        	                </table>	
        		                                </form>
	        	                        </div>
        	        	                <!-- End form to edit meetme -->
				
						<?php
							include "include/loginsql.php";
		                                        $sql="SELECT id,confno,pin,adminpin,members,maxusers from meetme order by confno asc";
							 ...
							 echo "<table class='table table-bordered table-striped table-condensed'>
								 ...
								 echo "<tr id=". $row['id'] .">";
		                                                echo "<td>" . $row['confno'] . "</td>";
                		                                echo "<td>" . $row['pin'] . "</td>";
                                		                echo "<td>" . $row['adminpin'] . "</td>";
                                                		//echo "<td>" . $row['members'] . "</td>";
		                                                echo "<td>" . $row['maxusers'] . "</td>";
                                                                echo "<td><button class='btn btn-info edidmeet' value=". $row['id'] ."><i class='icon-edit icon-white'></i></a></td>";
                                                                echo "<td><button class='btn btn-danger delidmeet' value=". $row['id'] ."><i class='icon-trash icon-white'></i></td>";
                                                        }
                                                                echo "</tr>";
                                                        echo "</tbody>
                                                        </table>";
					...
					<div class="tab-pane" id="addnewmeet">

		                                <!-- form to add meetme room -->
		                                        <form>
                		                              	<table align=center class='table table-bordered table-striped table-condensed'>
                                			                <tr><td><label for="confno">Room Number</label></td><td><input autofocus type="text" name="confno" id="confno" class="input-large ui-widget-content ui-corner-all" title="The number of the Room" data-rel="tooltip"/></td></tr>
			                                                <tr><td><label for="pin">PIN</label></td><td><input autofocus type="text" name="pin" id="pin" value="" class="input-large ui-widget-content ui-corner-all" title="Optional. Set the user Password to join the room." data-rel="tooltip"/></td></tr>
                        			                        <tr><td><label for="adminpin">Admin PIN</label></td><td><input autofocus type="text" name="adminpin" id="adminpin" value="" class="input-large ui-widget-content ui-corner-all" title="Optional. Set the Admin Password" data-rel="tooltip"/></td></tr>
                                                			<tr><td><label for="maxusers">Maximun Users</label></td><td><input autofocus type="text" name="maxusers" id="maxusers" value="" class="input-large ui-widget-content ui-corner-all" title="Set the maximums user can join the room. Blank for no limit" data-rel="tooltip"/></td></tr>
		                                                </table>

                		                        </form>
		                                <!-- End form to add meetme -->


						<div class="form-actions">
							<button  class="btn-primary" id="submeet">Submit</button>
