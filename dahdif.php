	...
	<div class="row-fluid sortable">	
		<div class="box span12">
			...
			<div class="box-content">
					...
					<div id="dialog-messagedd" title="Done!">
                                                <p>
				  ...
				  <p>
                           		...
                           		<?php
                                     		// set file to read
	                                        $filename3 = "/etc/asterisk/chan_dahdi.conf";
        	                                $newdata3 = $_POST['newd3'];
                	                        if ($newdata3 != '') {
                                            	    // open file
                                                	$fw3 = fopen($filename3, 'w') or die('Could not open file!');
	                                                // write to file
        	                                        // added stripslashes to $newdata
                	                                $fb3 = fwrite($fw3,stripslashes($newdata3)) or die('Could not write to file');
                        	                        // close file
                                	                fclose($fw3);
                        	                }

                                        	// open file
	                                        $fh3 = fopen($filename3, "r") or die("Could not open file!");
        	                                // read file contents
                	                        $data3 = fread($fh3, filesize($filename3)) or die("Could not read file!");
                        	                // close file
                                	        fclose($fh3);
                                        	// print file contents
	
	                                        echo "<button id='reloaddahdi' class='btn btn-primary'><i class='icon-zoom-in icon-refresh'></i>Reload</button>"; 
        	                                echo "<form action='".$_SERVER['PHP_SELF']."#dahdi' method='post' >";
 						echo "<style type=text/css>
                	                        ...
                	                        echo "<textarea id='styled' name='newd3' cols='80' rows='50'> $data3 </textarea>
                        	                <button class='btn btn-primary'><i class='icon icon-darkgray icon-save'></i>Save</button>
                                	        </form>";
