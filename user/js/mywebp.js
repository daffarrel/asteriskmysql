...
/****************************************/
	...
	function startSipStack(){
		...
		mySipStack  = new SIPml.Stack({
		        realm: 'asterisk',
		        impi: ''+$("#mypeer").val()+'',
		        impu: 'sip:'+$("#mypeer").val()+'@'+''+$("#myserverip").val()+'',
		        password: ''+$("#mypwd").val()+'', // optional
		        display_name: ''+$("#myname").val()+'', // optional
		        websocket_proxy_url: 'ws://'+$("#myserverip").val()+':10060', // optional
		        outbound_proxy_url: 'udp://'+$("#myserverip").val()+':5060', // optional
