		...
		<div class="box span12">
			...
			<div class="box-content">
				<ul class="nav nav-tabs" id="myTab">
					<li class="active"><a href="#apps">Asterisk Applications</a></li>
					<li><a href="#funcs">Asterisk Functions</a></li>
				...
				<div id="myTabContent" class="tab-content">
					<div class="tab-pane active" id="apps">
						<p>
							View the Help on the Listed Applications				
						</p>
							...
							require_once('/var/lib/asterisk/agi-bin/phpagi-asmanager.php');
						        ...
						        $asm = new AGI_AsteriskManager();
						          if($asm->connect('localhost','admin','m4nag3rt3ts')){
						                $peer = $asm->command("core show applications");
						                $data = array();
					                        echo "<select id='astapps' name='astapps' class='text ui-widget-content ui-corner-all'>";
						                foreach(explode("\n", $peer['data']) as $line){
									$app = explode(":",$line);
									$astapp = preg_replace("/\s/","",$app[0]);
									echo "<option value='".$astapp."'>".$astapp." - ".$app[1]."</option>";
						                }
								echo "</select>";
						          }
						         $asm->disconnect();
