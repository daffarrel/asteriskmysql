	...
	<div class="row-fluid sortable">	
		<div class="box span12">
			...
			<div class="box-content">
					...
					<div id="dialog-message3" title="Done!">
                                                <p>
				  ...
				  <p>
                           		...
                           		<?php
                                     		// set file to read
	                                        $filename3 = "/etc/asterisk/sip.conf";
	                                        ...
	                                        echo "<button id='reloadsip' class='btn btn-primary'><i class='icon-zoom-in icon-refresh'></i>Reload</button>"; 
        	                                echo "<form action='".$_SERVER['PHP_SELF']."#sip' method='post' >";
