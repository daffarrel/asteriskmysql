					...
					<div class="tab-pane" id="addnewsip">
						...
						<form>
							<table class='table  table-bordered table-striped table-condensed'>
								...
								<tr><td><label for="context">Context</label></td><td><input type="text" name="context" id="context" value="from-internal" class="input-large ui-widget-content ui-corner-all" title="The Context with the dial rules of this device" data-rel="tooltip"/></td></tr>
								...
								<tr><td><label for="encryption">Encryption</label></td><td><select name="encryption" id="encryption" class="input-large ui-widget-content ui-corner-all"><option value="no">no</option><option value="yes">yes</option></select></td></tr>
								<tr><td><label for="videosupport">Video Support</label></td><td><select name="videosupport" id="videosupport" class="input-large ui-widget-content ui-corner-all" title="Enable if Device can handle Video." data-rel="tooltip"><option value="yes">yes</option><option value="no">no</option></select></td></tr>
                                <tr><td><label for="nat">NAT</label></td><td><select name="nat" id="nat" class="input-large ui-widget-content ui-corner-all"><option value="force_rport,comedia">yes(force_rport,comedia)</option><option value="no">no</option><option value="comedia">comedia</option><option value="force_rport">force_rport</option><option value="yes">yes</option></select></td></tr>
