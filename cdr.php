	...
	<div class="row-fluid sortable">	
		<div class="box span12">
			...
			<div class="box-content">
				...
				<p >From Date: <input type="text" class="datepicker  ui-widget-content ui-corner-all" id="range1" size="15"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To Date:<input type="text" class="datepicker ui-widget-content ui-corner-all" id="range2" size="15"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>Report: <select id="filterslct" class='ui-widget ui-widget-content ui-corner-all'><option>- Choose -</option><option value="All">All</option><option value="extension">Extension</option><option value="accountcode">AccountCode</option></select></p>
				...
				<table>
					<tr>
					<td><button class='btn btn-primary' id="lookcdr"><i class="icon-zoom-in icon-search"></i> Search</button></td> 		
					<td><a class='btn btn-primary' id='dwlink' href=''><i class="icon-zoom-in icon-download-alt"></i> Download Report</a></td>
					</tr>
				</table>
